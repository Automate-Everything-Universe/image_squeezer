...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--width", help="New width", default=640)
    group.add_argument(
        "--suffix",
        action="store_true",
        help="Adds a suffix at the end of the file name (e.g. _resized)",
        default=False,
    )
    group.add_argument(
        "--backup",
        action="store_true",
        help="A backup folder with the original files will be created",
        default=True,
    )
